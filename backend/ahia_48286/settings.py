"""
Django settings for ahia_48286 project.
...
WSGI_APPLICATION = 'ahia_48286.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ahia_48286 API",
    "DESCRIPTION": "API documentation for ahia_48286 App",
    "VERSION": "v1",
}
